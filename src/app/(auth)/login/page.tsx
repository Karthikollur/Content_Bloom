  ...
  return (
    ...
    >
      ...
      {resetSuccess && (
        <div
          role="status"
          className="bg-accent/10 text-accent text-sm px-3 py-2 rounded-lg mb-4"
        >
      ...
      {error && (
        <div role="alert" className="bg-danger/10 text-danger text-sm px-3 py-2 rounded-lg mb-4">
          {error}
        </div>
      )}
      ...
      <form onSubmit={handleEmailLogin} className="space-y-4">
        ...
        <div>
          <div className="flex items-center justify-between mb-1.5">
            <label htmlFor="password" className="block text-text-secondary text-sm">
              Password
            </label>
            <Link
